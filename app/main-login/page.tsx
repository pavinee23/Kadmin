		...
		<div style={styles.page}>
			...
			{success && (
				<div style={styles.successOverlay}>
					<div style={styles.successCard}>
						...
						<div style={styles.successText}><span>Login Successful!</span></div>
						<div style={styles.successSubtext}><span>Redirecting to dashboard...</span></div>
					</div>
				</div>
			)}
			...
			<main style={styles.card}>
				...
				<div style={styles.logoSection}>
					...
					<h1 style={styles.brandName}><span>K Energy Save Co., Ltd</span></h1>
					<p style={styles.tagline}><span>ENERGY...YOU CAN TRUST.</span></p>
					<p style={styles.subTagline}><span>{'"SAVINGS" YOU CAN SEE.'}</span></p>
					<div style={styles.divider}></div>
				</div>

				<form onSubmit={handleSubmit} style={styles.form}>
					<h2 style={styles.formTitle}><span>Login</span></h2>
				...
				<div style={styles.features}>
					<div style={styles.feature}>
						...
						<span style={styles.featureText}><span>7-15% Electricity Savings</span></span>
					</div>
					<div style={styles.feature}>
						<span style={styles.featureIcon}>✓</span>
						<span style={styles.featureText}><span>Patented & Certified</span></span>
					</div>
					<div style={styles.feature}>
						<span style={styles.featureIcon}>🌍</span>
						<span style={styles.featureText}><span>Trusted in 40+ Countries</span></span>
					</div>
				</div>
				...
				<footer style={styles.footer}>
					<div style={styles.footerLinks}>
						<a href="/contact" style={styles.link}><span>Need Help?</span></a>
						<span style={styles.footerDot}>•</span>
						<a href="/privacy-policy" style={styles.link}><span>Privacy Policy</span></a>
					</div>
					<p style={styles.copyright}><span>© 2026 K Energy Save Co., Ltd. All rights reserved.</span></p>
				</footer>
			</main>
