...
export default function PrivacyPolicyPage() {
	...
	const translations = {
		en: {
			...
			introText: 'K Energy Save Co., Ltd. (Group of Zera) ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.',
		...
		th: {
			...
			introduction: 'บทนำ',
			introText: 'บริษัท เค เอ็นเนอร์ยี่ เซฟ จำกัด (Group of Zera) ("เรา" หรือ "บริษัท") มุ่งมั่นที่จะปกป้องความเป็นส่วนตัวของคุณ นโยบายความเป็นส่วนตัวนี้อธิบายวิธีที่เราเก็บรวบรวม ใช้ เปิดเผย และปกป้องข้อมูลของคุณเมื่อคุณเข้าชมเว็บไซต์หรือใช้บริการของเรา',
		...
		ko: {
			...
			introduction: '소개',
			introText: 'K 에너지 세이브 주식회사 (Group of Zera) ("당사")는 귀하의 개인정보를 보호하기 위해 최선을 다하고 있습니다. 본 개인정보 처리방침은 귀하가 당사 웹사이트를 방문하거나 서비스를 이용할 때 당사가 귀하의 정보를 수집, 사용, 공개 및 보호하는 방법을 설명합니다.',
		...
		zh: {
			...
			introduction: '简介',
			introText: 'K 能源节省有限公司 (Group of Zera) （"我们"或"公司"）致力于保护您的隐私。本隐私政策说明了当您访问我们的网站或使用我们的服务时，我们如何收集、使用、披露和保护您的信息。',
		...
		vi: {
			...
			lastUpdated: 'Cập nhật lần cuối: 13 tháng 1 năm 2026',
			introduction: 'Giới thiệu',
			introText: 'Công ty TNHH K Energy Save (Group of Zera) ("chúng tôi" hoặc "công ty") cam kết bảo vệ quyền riêng tư của bạn. Chính sách bảo mật này giải thích cách chúng tôi thu thập, sử dụng, tiết lộ và bảo vệ thông tin của bạn khi bạn truy cập trang web hoặc sử dụng dịch vụ của chúng tôi.',
			informationWeCollect: 'Thông Tin Chúng Tôi Thu Thập',
			personalInfo: 'Thông Tin Cá Nhân',
			personalInfoText: 'Chúng tôi có thể thu thập thông tin cá nhân mà bạn tự nguyện cung cấp khi bạn:',
			personalInfoList: [
				'Điền vào biểu mẫu liên hệ của chúng tôi (tên, email, số điện thoại, tên công ty)',
				'Yêu cầu báo giá hoặc thông tin sản phẩm',
				'Đăng ký nhận bản tin hoặc thông tin liên lạc của chúng tôi',
			...
			automaticInfoText: 'Khi bạn truy cập trang web của chúng tôi, chúng tôi có thể tự động thu thập một số thông tin về thiết bị của bạn, bao gồm:',
			automaticInfoList: [
				'Địa chỉ IP và loại trình duyệt',
				'Hệ điều hành và thông tin thiết bị',
				'Các trang đã truy cập và thời gian ở lại trên mỗi trang',
				'Địa chỉ trang web giới thiệu',
				'Cookie và các công nghệ theo dõi tương tự'
			],
			howWeUse: 'Cách Chúng Tôi Sử Dụng Thông Tin Của Bạn',
			howWeUseText: 'Chúng tôi sử dụng thông tin thu thập được để:',
			howWeUseList: [
				'Trả lời các câu hỏi của bạn và cung cấp hỗ trợ khách hàng',
				'Xử lý yêu cầu báo giá và quan hệ đối tác kinh doanh',
				'Gửi thông tin sản phẩm và tài liệu quảng cáo (với sự đồng ý của bạn)',
				'Cải thiện trang web và dịch vụ của chúng tôi',
				'Phân tích mẫu sử dụng và tối ưu hóa trải nghiệm người dùng',
				'Tuân thủ nghĩa vụ pháp lý và ngăn chặn gian lận'
			],
			informationSharing: 'Chia Sẻ và Tiết Lộ Thông Tin',
			informationSharingText: 'Chúng tôi không bán, trao đổi hoặc cho thuê thông tin cá nhân của bạn cho bên thứ ba. Chúng tôi chỉ chia sẻ thông tin của bạn trong các trường hợp sau:',
			informationSharingList: [
				'Với các nhà cung cấp dịch vụ hỗ trợ chúng tôi vận hành trang web và kinh doanh',
				'Khi được yêu cầu bởi pháp luật hoặc để bảo vệ quyền và an toàn của chúng tôi',
				'Với sự đồng ý rõ ràng của bạn',
				'Liên quan đến việc chuyển nhượng hoặc sáp nhập kinh doanh'
			],
			dataSecurity: 'Bảo Mật Dữ Liệu',
			dataSecurityText: 'Chúng tôi thực hiện các biện pháp kỹ thuật và tổ chức thích hợp để bảo vệ thông tin cá nhân của bạn khỏi việc truy cập, thay đổi, tiết lộ hoặc phá hủy trái phép. Tuy nhiên, không có phương thức truyền tải qua Internet nào là 100% an toàn.',
			cookies: 'Cookie và Công Nghệ Theo Dõi',
			cookiesText: 'Chúng tôi sử dụng cookie và các công nghệ theo dõi tương tự để nâng cao trải nghiệm của bạn trên trang web. Bạn có thể kiểm soát cài đặt cookie thông qua tùy chọn trình duyệt của mình.',
			yourRights: 'Quyền Của Bạn',
			yourRightsText: 'Tùy thuộc vào vị trí của bạn, bạn có thể có các quyền sau:',
			yourRightsList: [
			...
			thirdPartyLinksText: 'Trang web của chúng tôi có thể chứa liên kết đến các trang web của bên thứ ba. Chúng tôi không chịu trách nhiệm về các thực hành bảo mật của các trang web bên ngoài này. Chúng tôi khuyến khích bạn đọc chính sách bảo mật của họ.',
			childrenPrivacy: 'Quyền Riêng Tư Trẻ Em',
			childrenPrivacyText: 'Dịch vụ của chúng tôi không hướng đến những cá nhân dưới 18 tuổi. Chúng tôi không cố ý thu thập thông tin cá nhân từ trẻ em.',
			international: 'Chuyển Giao Dữ Liệu Quốc Tế',
			internationalText: 'Thông tin của bạn có thể được chuyển đến và xử lý tại các quốc gia khác ngoài quốc gia cư trú của bạn. Chúng tôi đảm bảo có các biện pháp bảo vệ thích hợp cho các chuyển giao như vậy.',
			changes: 'Thay Đổi Chính Sách Bảo Mật',
			changesText: 'Chúng tôi có thể cập nhật Chính sách bảo mật này theo thời gian. Chúng tôi sẽ thông báo cho bạn về bất kỳ thay đổi nào bằng cách đăng Chính sách bảo mật mới trên trang này với ngày "Cập nhật lần cuối" đã được cập nhật.',
			contact: 'Liên Hệ Chúng Tôi',
			contactText: 'Nếu bạn có bất kỳ câu hỏi hoặc thắc mắc nào về Chính sách bảo mật này, vui lòng liên hệ với chúng tôi:',
			contactInfo: [
				'Điện thoại: +82 31-427-1380',
				'Email: info@kenergy-save.com / info@zera-energy.com',
				'LINE chính thức: @534znjie',
				'Giờ làm việc: Thứ Hai - Thứ Sáu, 9:00 SA - 6:00 CH'
			],
			dataRetention: 'Lưu Trữ Dữ Liệu',
			dataRetentionText: 'Chúng tôi chỉ lưu giữ thông tin cá nhân của bạn trong thời gian cần thiết để đạt được các mục đích được nêu trong Chính sách bảo mật này, trừ khi pháp luật yêu cầu hoặc cho phép thời gian lưu trữ lâu hơn.',
			...
			<main style={styles.container}>
				...
				<div style={styles.card}>
					...
					<div style={styles.header}>
						<div
							style={{...styles.logoCircle, cursor: 'pointer'}}
					...
					{/* Hidden Admin Login Button (Easter Egg: Click logo 5 times) */}
					{showAdminButton && (
