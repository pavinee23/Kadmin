...
export default function ProductsListPage() {
  ...
  return (
    <AdminLayout title="Products — List" titleTh="รายการสินค้า">
      <div className={styles.contentCard}>
        <div className={styles.cardHeader}>
          <h2 className={styles.cardTitle}>{L('Products — List', 'รายการสินค้า')}</h2>
        ...
        <div className={styles.cardBody}>
          <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <button
              onClick={() => router.push('/Thailand/Admin-Login/product-add')}
              ...
              <tbody>
                ...
                {products.map((product) => (
                  <tr key={product.id}>
                    ...
                    <td>
                      <a
                        href={`/Thailand/Admin-Login/products/view?id=${product.id}`}
                    ...
                    <td>
                      <div style={{ display: 'flex', gap: 8, justifyContent: 'center' }}>
                        {editingId === product.id ? (
                          ...
                          <>
                            <button
                              onClick={() => router.push(`/Thailand/Admin-Login/products/view?id=${product.id}`)}
                              className={styles.btnOutline}
                              style={{ padding: '6px 12px', fontSize: 13 }}
                            >
                              {L('View', 'ดู')}
