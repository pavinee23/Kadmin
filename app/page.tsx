				...
				<div className="container">
					<div className="row justify-content-center">
						<div className="col-lg-10 text-center" style={{ position: 'relative', zIndex: 1 }}>
							<div className="logo-hero mx-auto" style={{ width: 60, height: 60, borderRadius: '50%', overflow: 'hidden' }}>
								<img src="/k-energy-save-logo.jpg" alt="K Energy Save" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
							</div>
